...
A no-deps body parsing middleware for the Velocy framework that handles JSON, URL-encoded, multipart form data, and raw body parsing using only Node.js built-in modules.
