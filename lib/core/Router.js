      ...
      if (pathMiddleware) {
        ...
        for (const [pathPrefix, middlewares] of pathMiddleware.entries()) {
          if (url.startsWith(pathPrefix)) {
            // Set baseUrl for path-mounted middleware
        ...
        if (middlewareIndex < allMiddleware.length) {
          ...
          if (!routeHandler) {
            ...
            if (this._routeCache) {
              ...
              if (cached) {
                // Reconstruct the route handler from cached data
                // Create a new params object to avoid frozen object issues
          ...
          if (this._paramsPool) {
            ...
            usedPoolForParams = true;
            // Copy params properties to avoid frozen object issues
          ...
          // Return params object to pool only if it came from the pool
