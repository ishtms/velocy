 ...
 * I'm using a tree structure for fast route matching with O(segments) complexity.
...
class RouteNode {
   ...
   * I'm organizing route matching with different node types for optimal performance.
 ...
 * I'm using a radix tree (compressed trie) for O(log n) route lookup with support for
...
class Router {
   ...
   * I'm using lazy initialization for features to keep the router lightweight
