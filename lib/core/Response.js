 ...
 * I'm wrapping Node's native ServerResponse to provide a cleaner API with features like
...
class Response {
   ...
   * I'm initializing the response with sensible defaults and optionally
   * extracting cookie secret and view engine from the router for advanced features.
   * 
   * @constructor
   ...
   * I'm maintaining this method for backward compatibility with Node.js APIs
   ...
   * I'm ensuring headers are sent before ending and handling HEAD requests
   ...
   * I'm returning 'this' to enable method chaining for cleaner code.
   * 
   ...
   * I'm automatically setting the Content-Type header and stringifying the data.
   ...
   * I'm automatically detecting the data type and setting appropriate headers.
   ...
   * I'm using 302 as default status for temporary redirects, but you can
   ...
   * I'm using HMAC-SHA256 with URL-safe Base64 encoding to create
   ...
   * I'm implementing full cookie specification with all security attributes.
   ...
   * I'm providing full cookie specification support including security attributes.
   ...
   * I'm setting the expiration to epoch time (Jan 1, 1970) to ensure
   ...
   * I'm providing shortcuts for common MIME types to make the API more convenient.
   * 
   ...
   * I'm supporting both single header and object notation for flexibility.
   * 
   ...
   * I'm checking exact match first for performance, then falling back
   ...
   * I'm providing this alias for Express compatibility.
   * 
   * @param {string} field - Header name to retrieve
   * @returns {string|undefined} Header value or undefined if not set
   * @example
   ...
   * I'm providing this method for compatibility with Node.js HTTP module.
   * 
   ...
   * I'm providing this for cases where you need to unset a previously set header.
   * 
   ...
   * I'm handling multiple values for headers that support them (like Set-Cookie).
   ...
   * I'm tracking this to prevent errors from trying to modify headers
   ...
   * I'm delegating to the native response's finished property.
   * 
   ...
   * I'm exposing this with underscore prefix to indicate it's for
   ...
   * I'm exposing this for middleware that needs direct access to
   ...
   * I'm using locals to pass data to view templates that's specific
   ...
   * I'm only accepting objects to ensure locals remains a proper container.
   * 
   ...
   * I'm supporting both callback and Promise-based APIs for flexibility.
   ...
   * I'm detecting MIME types, setting cache headers, and streaming the file
   ...
   * I'm delegating to the native response for stream compatibility.
   * 
   ...
   * I'm ensuring headers are sent before writing to prevent errors.
   ...
   * I'm delegating to native response for EventEmitter compatibility.
   * 
   ...
   * I'm exposing stream state for compatibility with stream-based middleware.
   * 
   ...
   * I'm exposing this for middleware that needs to know if end() was called.
   * 
   ...
   * I'm exposing this for middleware that needs to know if all data was flushed.
   * 
