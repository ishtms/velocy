 ...
 * I'm wrapping Node's native IncomingMessage to provide a cleaner API with features like
 * cookie parsing, query string handling, body parsing, and content negotiation. This abstraction
 * allows us to add framework-specific functionality without modifying the native request.
 *
 * @class Request
 * @example
...
class Request {
   ...
   * I'm initializing the request with the native request and optionally a router
  ...
  /**
   * Sets the route parameters. I'm freezing the params object to prevent
   ...
   * I'm returning a frozen copy to ensure immutability.
   *
  ...
  /**
   * Sets the URL path. I'm allowing URL modification for internal routing
   ...
   * I'm normalizing header keys to lowercase for consistent access since
   * HTTP headers are case-insensitive. For performance, I only normalize
   ...
   * I'm providing this method for Express compatibility and convenience.
   *
   ...
   * I'm caching the parsed path for performance since it's accessed frequently
   ...
   * I'm using a sophisticated parser that handles arrays, nested objects,
   ...
   * I'm implementing a full-featured parser that matches the behavior of popular
   ...
   * I'm handling complex key patterns like 'items[0][name]' or 'filters[category][]'
   ...
   * I'm breaking down complex bracket notation like '[0][name]' into
   ...
   * I'm automatically converting string values to their intended types
   ...
   * I'm wrapping decodeURIComponent in a try-catch because malformed
   * URLs shouldn't crash the application. Also handling '+' as space
   ...
   * I'm separating signed and unsigned cookies for security. Signed cookies
   ...
   * I'm using HMAC-SHA256 for cookie signing as it provides strong
   ...
   * I'm using crypto.timingSafeEqual for constant-time comparison to
   ...
   * I'm excluding signed cookies from this object for security - they're
   ...
   * I'm only returning cookies that pass signature verification to ensure
   ...
   * I'm checking proxy headers first (X-Forwarded-For, X-Real-IP) since
   ...
   * I'm extracting just the hostname part, removing the port if present.
   ...
   * I'm checking X-Forwarded-Proto header first for proxy scenarios,
   * then falling back to socket encryption status.
   *
   ...
   * I'm returning a Promise because body parsing is asynchronous.
   ...
   * I'm collecting the raw body chunks into a Buffer for cases where
   ...
   * I'm supporting JSON, URL-encoded, and multipart form data out of the box.
   ...
   * I'm implementing a basic multipart parser for file uploads and form data.
   ...
   * I'm providing this for easy content-type checking with support for
   ...
   * I'm implementing content negotiation based on the Accept header,
   ...
   * I'm providing this convenience method since JSON API responses
   ...
   * I'm providing this for easy content negotiation between
   ...
   * I'm parsing the Accept header according to RFC 7231, extracting
   ...
   * I'm converting shortcuts like 'json' to full MIME types
   ...
   * I'm supporting wildcards like *\/* and text/* for flexible
   ...
   * I'm exposing this for compatibility with Node.js libraries
   ...
   * I'm delegating to the native request's setTimeout for
   ...
   * I'm providing both connection and socket properties for
   ...
   * I'm providing this alias since newer Node.js versions
