/**
 * Velocy Framework - Main exports module
 * 
 * High-performance HTTP framework for Node.js with zero-cost abstractions.
 * Provides routing, middleware, WebSocket support, and utilities for building
 * fast web applications and APIs.
 * 
 * @module velocy
 * @version 1.0.0
 * @example
 * const { Router, bodyParser, cors } = require('velocy');
 * 
